...
void
PrefsLogging::on_LogFilePostamble_textChanged()
{
  world.setLogFilePostamble(ui->LogFilePostamble->toPlainText());
}

void
PrefsLogging::on_LogFilePreamble_textChanged()
{
  world.setLogFilePreamble(ui->LogFilePreamble->toPlainText());
}

void
PrefsLogging::on_LogFormatChanged(LogFormat value)
{
  world.setLogFormat(value);
}

void
PrefsLogging::on_LogModeChanged(LogMode value)
{
  world.setLogMode(value);
}

void
PrefsLogging::on_view_special_clicked()
{
