...
IconLabel::IconLabel(const QIcon &icon, QIcon::Mode mode, QIcon::State state,
                     QWidget *parent)
    : QLabel(parent), icon(icon), maxSize(icon.availableSizes().constLast()),
...
void IconLabel::setIcon(const QIcon &newIcon, QIcon::Mode newMode,
...
bool IconLabel::hasHeightForWidth() const { return true; }
