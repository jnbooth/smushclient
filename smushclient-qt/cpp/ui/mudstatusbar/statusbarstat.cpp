...
StatusBarStat::StatusBarStat(const QString &entity, const QString &caption,
                             const QString &maxEntity, QWidget *parent)
    : QWidget(parent), ui(new Ui::StatusBarStat), entityName(entity),
...
QPalette StatusBarStat::chooseColor(const QWidget *source) {
  ...
  const QColor color = QColorDialog::getColor(
      colorPalette.color(QPalette::ColorRole::WindowText), this,
      displayMenu->title(), QColorDialog::ColorDialogOption::ShowAlphaChannel);
