...
SmushClient::SmushClient(QObject *parent) : SmushClientBase(parent) {}

VariableView SmushClient::getVariable(size_t index,
                                      string_view key) const noexcept {
  size_t size;
  const char *data =
      SmushClientBase::getVariable(index, stringSlice(key), &size);
