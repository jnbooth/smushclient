...
static const pair<string, lua_Integer> miniwin[] = {
  ...
  { "pos_center_right",
    static_cast<lua_Integer>(MiniWindow::Position::CenterRight) },
  { "pos_bottom_right",
    static_cast<lua_Integer>(MiniWindow::Position::BottomRight) },
  { "pos_bottom_center",
    static_cast<lua_Integer>(MiniWindow::Position::BottomCenter) },
  { "pos_bottom_left",
    static_cast<lua_Integer>(MiniWindow::Position::BottomLeft) },
  { "pos_center_left",
    static_cast<lua_Integer>(MiniWindow::Position::CenterLeft) },
  { "pos_center_all", static_cast<lua_Integer>(MiniWindow::Position::Center) },
  { "pos_tile", static_cast<lua_Integer>(MiniWindow::Position::Tile) },
  ...
  { "brush_solid", static_cast<lua_Integer>(ScriptBrush::SolidPattern) },
  { "brush_null", static_cast<lua_Integer>(ScriptBrush::NoBrush) },
  { "brush_hatch_horizontal",
    static_cast<lua_Integer>(ScriptBrush::HorPattern) },
  { "brush_hatch_vertical", static_cast<lua_Integer>(ScriptBrush::VerPattern) },
  { "brush_hatch_forwards_diagonal",
    static_cast<lua_Integer>(ScriptBrush::FDiagPattern) },
  { "brush_hatch_backwards_diagonal",
    static_cast<lua_Integer>(ScriptBrush::BDiagPattern) },
  { "brush_hatch_cross", static_cast<lua_Integer>(ScriptBrush::CrossPattern) },
  { "brush_hatch_cross_diagonal",
    static_cast<lua_Integer>(ScriptBrush::DiagCrossPattern) },
  { "brush_fine_pattern",
    static_cast<lua_Integer>(ScriptBrush::Dense4Pattern) },
  { "brush_medium_pattern",
    static_cast<lua_Integer>(ScriptBrush::Dense2Pattern) },
  { "brush_coarse_pattern",
    static_cast<lua_Integer>(ScriptBrush::Dense1Pattern) },
  { "brush_waves_horizontal", static_cast<lua_Integer>(ScriptBrush::HorWaves) },
  { "brush_waves_vertical", static_cast<lua_Integer>(ScriptBrush::VerWaves) },

  { "rect_frame", static_cast<lua_Integer>(RectOp::Frame) },
  { "rect_fill", static_cast<lua_Integer>(RectOp::Fill) },
  { "rect_invert", static_cast<lua_Integer>(RectOp::Invert) },
  { "rect_3d_rect", static_cast<lua_Integer>(RectOp::Frame3D) },
  { "rect_draw_edge", static_cast<lua_Integer>(RectOp::Edge3D) },
  { "rect_flood_fill_border",
    static_cast<lua_Integer>(RectOp::FloodFillBorder) },
  { "rect_flood_fill_surface",
    static_cast<lua_Integer>(RectOp::FloodFillSurface) },
  { "rect_edge_raised", 5 },
  { "rect_edge_etched", 6 },
  { "rect_edge_bump", 9 },
  { "rect_edge_sunken", 10 },
  ...
  { "circle_ellipse", static_cast<lua_Integer>(CircleOp::Ellipse) },
  { "circle_rectangle", static_cast<lua_Integer>(CircleOp::Rectangle) },
  { "circle_round_rectangle",
    static_cast<lua_Integer>(CircleOp::RoundedRectangle) },
  { "circle_chord", static_cast<lua_Integer>(CircleOp::Chord) },
  { "circle_pie", static_cast<lua_Integer>(CircleOp::Pie) },
  ...
  { "image_copy", static_cast<lua_Integer>(MiniWindow::DrawImageMode::Copy) },
  { "image_stretch",
    static_cast<lua_Integer>(MiniWindow::DrawImageMode::Stretch) },
  { "image_transparent_copy",
    static_cast<lua_Integer>(MiniWindow::DrawImageMode::CopyTransparent) },

  { "image_fill_ellipse", static_cast<lua_Integer>(ImageOp::Ellipse) },
  { "image_fill_rectangle", static_cast<lua_Integer>(ImageOp::Rectangle) },
  { "image_fill_round_fill_rectangle",
    static_cast<lua_Integer>(ImageOp::RoundedRectangle) },
  ...
  { "cursor_none", static_cast<lua_Integer>(ScriptCursor::BlankCursor) },
  { "cursor_arrow", static_cast<lua_Integer>(ScriptCursor::ArrowCursor) },
  { "cursor_hand", static_cast<lua_Integer>(ScriptCursor::OpenHandCursor) },
  { "cursor_ibeam", static_cast<lua_Integer>(ScriptCursor::IBeamCursor) },
  { "cursor_plus", static_cast<lua_Integer>(ScriptCursor::CrossCursor) },
  { "cursor_wait", static_cast<lua_Integer>(ScriptCursor::WaitCursor) },
  { "cursor_up", static_cast<lua_Integer>(ScriptCursor::UpArrowCursor) },
  { "cursor_nw_se_arrow",
    static_cast<lua_Integer>(ScriptCursor::SizeFDiagCursor) },
  { "cursor_ne_sw_arrow",
    static_cast<lua_Integer>(ScriptCursor::SizeBDiagCursor) },
  { "cursor_ew_arrow", static_cast<lua_Integer>(ScriptCursor::SizeHorCursor) },
  { "cursor_ns_arrow", static_cast<lua_Integer>(ScriptCursor::SizeVerCursor) },
  { "cursor_both_arrow",
    static_cast<lua_Integer>(ScriptCursor::SizeAllCursor) },
  { "cursor_x", static_cast<lua_Integer>(ScriptCursor::ForbiddenCursor) },
  { "cursor_help", static_cast<lua_Integer>(ScriptCursor::WhatsThisCursor) },
