...
static const pair<string, lua_Integer> miniwin[] = {
  ...
  { "pen_solid", I(PenStyle::SolidLine) },
  { "pen_dash", I(PenStyle::DashLine) },
  { "pen_dot", I(PenStyle::DotLine) },
  { "pen_dash_dot", I(PenStyle::DashDotLine) },
  { "pen_dash_dot_dot", I(PenStyle::DashDotDotLine) },
  { "pen_null", I(PenStyle::NoPen) },
  { "pen_inside_frame", I(PenStyle::InsideFrame) },

  { "pen_endcap_round", I(PenCap::RoundCap) },
  { "pen_endcap_square", I(PenCap::SquareCap) },
  { "pen_endcap_flat", I(PenCap::FlatCap) },

  { "pen_join_round", I(PenJoin::RoundJoin) },
  { "pen_join_bevel", I(PenJoin::BevelJoin) },
  { "pen_join_miter", I(PenJoin::MiterJoin) },
  ...
  { "font_family_any", I(FontFamily::AnyFamily) },
  { "font_family_roman", I(FontFamily::Roman) },
  { "font_family_swiss", I(FontFamily::Swiss) },
  { "font_family_modern", I(FontFamily::Modern) },
  { "font_family_script", I(FontFamily::Script) },
  { "font_family_decorative", I(FontFamily::Decorative) },

  { "font_pitch_default", I(FontPitch::Default) },
  { "font_pitch_fixed", I(FontPitch::Fixed) },
  { "font_pitch_variable", I(FontPitch::Variable) },
  { "font_pitch_monospaced", I(FontPitch::Monospace) },
