...
static const pair<string, lua_Integer> miniwin[] = {
  ...
  { "pos_center_right", static_cast<int>(MiniWindow::Position::CenterRight) },
  { "pos_bottom_right", static_cast<int>(MiniWindow::Position::BottomRight) },
  { "pos_bottom_center", static_cast<int>(MiniWindow::Position::BottomCenter) },
  { "pos_bottom_left", static_cast<int>(MiniWindow::Position::BottomLeft) },
  { "pos_center_left", static_cast<int>(MiniWindow::Position::CenterLeft) },
  { "pos_center_all", static_cast<int>(MiniWindow::Position::Center) },
  { "pos_tile", static_cast<int>(MiniWindow::Position::Tile) },
  ...
  { "brush_solid", static_cast<int>(ScriptBrush::SolidPattern) },
  { "brush_null", static_cast<int>(ScriptBrush::NoBrush) },
  { "brush_hatch_horizontal", static_cast<int>(ScriptBrush::HorPattern) },
  { "brush_hatch_vertical", static_cast<int>(ScriptBrush::VerPattern) },
  { "brush_hatch_forwards_diagonal",
    static_cast<int>(ScriptBrush::FDiagPattern) },
  { "brush_hatch_backwards_diagonal",
    static_cast<int>(ScriptBrush::BDiagPattern) },
  { "brush_hatch_cross", static_cast<int>(ScriptBrush::CrossPattern) },
  { "brush_hatch_cross_diagonal",
    static_cast<int>(ScriptBrush::DiagCrossPattern) },
  { "brush_fine_pattern", static_cast<int>(ScriptBrush::Dense4Pattern) },
  { "brush_medium_pattern", static_cast<int>(ScriptBrush::Dense2Pattern) },
  { "brush_coarse_pattern", static_cast<int>(ScriptBrush::Dense1Pattern) },
  { "brush_waves_horizontal", static_cast<int>(ScriptBrush::HorWaves) },
  { "brush_waves_vertical", static_cast<int>(ScriptBrush::VerWaves) },

  { "rect_frame", static_cast<int>(RectOp::Frame) },
  { "rect_fill", static_cast<int>(RectOp::Fill) },
  { "rect_invert", static_cast<int>(RectOp::Invert) },
  { "rect_3d_rect", static_cast<int>(RectOp::Frame3D) },
  { "rect_draw_edge", static_cast<int>(RectOp::Edge3D) },
  { "rect_flood_fill_border", static_cast<int>(RectOp::FloodFillBorder) },
  { "rect_flood_fill_surface", static_cast<int>(RectOp::FloodFillSurface) },
  { "rect_edge_raised", 5 },
  { "rect_edge_etched", 6 },
  { "rect_edge_bump", 9 },
  { "rect_edge_sunken", 10 },
  ...
  { "circle_ellipse", static_cast<int>(CircleOp::Ellipse) },
  { "circle_rectangle", static_cast<int>(CircleOp::Rectangle) },
  { "circle_round_rectangle", static_cast<int>(CircleOp::RoundedRectangle) },
  { "circle_chord", static_cast<int>(CircleOp::Chord) },
  { "circle_pie", static_cast<int>(CircleOp::Pie) },
  ...
  { "image_copy", static_cast<int>(MiniWindow::DrawImageMode::Copy) },
  { "image_stretch", static_cast<int>(MiniWindow::DrawImageMode::Stretch) },
  { "image_transparent_copy",
    static_cast<int>(MiniWindow::DrawImageMode::CopyTransparent) },

  { "image_fill_ellipse", static_cast<int>(ImageOp::Ellipse) },
  { "image_fill_rectangle", static_cast<int>(ImageOp::Rectangle) },
  { "image_fill_round_fill_rectangle",
    static_cast<int>(ImageOp::RoundedRectangle) },
  ...
  { "cursor_none", static_cast<int>(ScriptCursor::BlankCursor) },
  { "cursor_arrow", static_cast<int>(ScriptCursor::ArrowCursor) },
  { "cursor_hand", static_cast<int>(ScriptCursor::OpenHandCursor) },
  { "cursor_ibeam", static_cast<int>(ScriptCursor::IBeamCursor) },
  { "cursor_plus", static_cast<int>(ScriptCursor::CrossCursor) },
  { "cursor_wait", static_cast<int>(ScriptCursor::WaitCursor) },
  { "cursor_up", static_cast<int>(ScriptCursor::UpArrowCursor) },
  { "cursor_nw_se_arrow", static_cast<int>(ScriptCursor::SizeFDiagCursor) },
  { "cursor_ne_sw_arrow", static_cast<int>(ScriptCursor::SizeBDiagCursor) },
  { "cursor_ew_arrow", static_cast<int>(ScriptCursor::SizeHorCursor) },
  { "cursor_ns_arrow", static_cast<int>(ScriptCursor::SizeVerCursor) },
  { "cursor_both_arrow", static_cast<int>(ScriptCursor::SizeAllCursor) },
  { "cursor_x", static_cast<int>(ScriptCursor::ForbiddenCursor) },
  { "cursor_help", static_cast<int>(ScriptCursor::WhatsThisCursor) },
