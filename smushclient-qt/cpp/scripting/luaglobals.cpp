...
static const pair<ApiCode, string> error_desc[] = {
    ...
    {ApiCode::BadDelimiter, "Import/export delimiter must be a single "
...
void pushValue(lua_State *L, int value) { lua_pushinteger(L, value); }
...
void registerTable(lua_State *L, const char *name,
                   const pair<K, V> (&entries)[N]) {
