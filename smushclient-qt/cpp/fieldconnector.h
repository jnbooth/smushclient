...
#define CONNECT_SETTINGS(field)                                                \
  connectField(this, &settings, ui->field, settings.get##field(),              \
               &Settings::set##field);
...
inline QMetaObject::Connection connectField(QObject *object, const T *target,
                                            QComboBox *input, const Enum value,
  ...
  return object->connect(input, &QComboBox::currentIndexChanged, target,
                         reinterpret_cast<Setter>(setter));
}

// bool
template <typename T>
QMetaObject::Connection connectField(QObject *object, const T *target,
                                     QCheckBox *input, const bool value,
...
template <typename T>
QMetaObject::Connection connectField(QObject *object, const T *target,
                                     QDoubleSpinBox *input, const double value,
...
template <typename T>
QMetaObject::Connection connectField(QObject *object, const T *target,
                                     QSpinBox *input, const int value,
...
connectField(QObject *object, const T *target, ColorPickerButton *input,
             const QColor &value, void (T::*&&setter)(QColor value)) {
  input->setValue(value);
  return object->connect(input, &ColorPickerButton::valueChanged, target,
                         setter);
}
...
QMetaObject::Connection
connectField(QObject *object, const T *target, ColorPickerButton *input,
             const QColor &value, void (T::*&&setter)(const QColor &value)) {
  input->setValue(value);
  return object->connect(input, &ColorPickerButton::valueChanged, target,
                         setter);
}
...
template <typename T>
QMetaObject::Connection connectField(QObject *object, const T *target,
                                     QLineEdit *input, const QString &value,
...
template <typename T>
QMetaObject::Connection
connectField(QObject *object, const T *target, QLineEdit *input,
             const QString &value, void (T::*&&setter)(const QString &value)) {
  input->setText(value);
  return object->connect(input, &QLineEdit::textChanged, target, setter);
}
...
template <typename T>
QMetaObject::Connection connectField(QObject *object, const T *target,
                                     QTimeEdit *input, const QTime &value,
