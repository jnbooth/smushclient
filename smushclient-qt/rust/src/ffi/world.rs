...
pub mod ffi {
    ...
    extern "RustQt" {
        ...
        #[qproperty(QString, log_line_preamble_output)]
        #[qproperty(QString, log_line_preamble_input)]
        #[qproperty(QString, log_line_preamble_notes)]
        #[qproperty(QString, log_line_postamble_output)]
        #[qproperty(QString, log_line_postamble_input)]
        #[qproperty(QString, log_line_postamble_notes)]
        ...
        #[qproperty(u8, speed_walk_prefix)]
