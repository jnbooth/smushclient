...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        #[rust_name = "qvariant_init_value_or_default_QTextFormat"]
        unsafe fn qvariantInitValueOrDefault(variant: &QVariant, uninit: *mut QTextFormat);
    }
}
...
pub(crate) fn value_or_default(variant: &ffi::QVariant) -> ffi::QTextFormat {
    ...
    unsafe { ffi::qvariant_init_value_or_default_QTextFormat(variant, uninit.as_mut_ptr()) };
    // SAFETY: ffi::qvariant_init_value_or_default_QTextFormat initializes the passed pointer in-place.
