...
pub mod ffi {
    ...
    struct WorldConfig {
        ...
        log_line_preamble_output: String,
        log_line_preamble_input: String,
        log_line_preamble_notes: String,
        log_line_postamble_output: String,
        log_line_postamble_input: String,
