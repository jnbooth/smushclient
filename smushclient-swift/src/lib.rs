...
mod ffi {
    ...
    enum OutputFragment {
        ...
        LineBreak,
        MxpError(String),
        MxpVariableSet { name: String, value: String },
        MxpVariableUnset { name: String },
        PageBreak,
        Send(SendRequest),
        Sound(String),
...
impl From<OutputFragment> for ffi::OutputFragment {
    fn from(value: OutputFragment) -> Self {
        match value {
            ...
            OutputFragment::MxpVariable {
                name,
                value: Some(value),
            } => Self::MxpVariableSet { name, value },
            OutputFragment::MxpVariable { name, value: None } => Self::MxpVariableUnset { name },
