...
class WorldModel {
  ...
  var log_line_preamble_output: String = ""
  var log_line_preamble_input: String = ""
  var log_line_preamble_notes: String = ""
  var log_line_postamble_output: String = ""
  var log_line_postamble_input: String = ""
  var log_line_postamble_notes: String = ""
  ...
  init(_ world: World) {
    ...
    log_line_preamble_output = world.log_line_preamble_output.toString()
    log_line_preamble_input = world.log_line_preamble_input.toString()
    log_line_preamble_notes = world.log_line_preamble_notes.toString()
    log_line_postamble_output = world.log_line_postamble_output.toString()
    log_line_postamble_input = world.log_line_postamble_input.toString()
    log_line_postamble_notes = world.log_line_postamble_notes.toString()
...
extension World {
  init(_ world: WorldModel) {
    ...
    log_line_preamble_output = world.log_line_preamble_output.intoRustString()
    log_line_preamble_input = world.log_line_preamble_input.intoRustString()
    log_line_preamble_notes = world.log_line_preamble_notes.intoRustString()
    log_line_postamble_output = world.log_line_postamble_output.intoRustString()
    log_line_postamble_input = world.log_line_postamble_input.intoRustString()
    log_line_postamble_notes = world.log_line_postamble_notes.intoRustString()
